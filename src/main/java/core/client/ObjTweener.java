...
public class ObjTweener implements TweenAccessor<Obj> {
    ...
    @Override
    public int getValues(Obj target, int tweenType, float[] returnValues) {
        switch (tweenType) {
    ...
    @Override
    public void setValues(Obj target, int tweenType, float[] newValues) {
        switch (tweenType) {
