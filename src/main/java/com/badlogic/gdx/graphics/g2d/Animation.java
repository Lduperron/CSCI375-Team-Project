...
public class Animation {
	...
	public Animation (float frameDuration, Array<? extends TextureRegion> keyFrames, int playType, Array<? extends BitSet> transparencyData) {
		...
		if(transparencyData != null)
		{
			...
			this.transparencyData = new BitSet[keyFrames.size];
		...
		for (int i = 0, n = keyFrames.size; i < n; i++) {
			...
			if(transparencyData != null)
			{
				...
				this.transparencyData[i] = transparencyData.get(i);
